...
baseurl = "https://www.efca.europa.eu/en/"
...
def make_results_page_url(i:int) -> str:
    return f"https://www.efca.europa.eu/en/news/latest?page={i}"
...
def process_page(url,date_elem_list, full_json):
    ...
    try:
        text = soup.select('div.field:nth-child(2) > div:nth-child(1)')[0].text.strip()
...
while go_on:
    ...
    results = r_p_soup.select("div.views-row")

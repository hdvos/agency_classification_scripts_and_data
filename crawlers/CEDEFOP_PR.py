...
base_url = "https://www.cedefop.europa.eu/en/news-and-press/press-and-media/press-releases/"
...
def make_results_page_url(i:int) -> str:
    return f"https://www.cedefop.europa.eu/en/news-and-press/press-and-media/press-releases?page={i}"
...
with open(os.path.join(output_folder, 'CEDEFOP_PR.json'), 'wt') as f:
    json.dump(full_json, f)

# write to csv
with open(os.path.join(output_folder,'CEDEFOP_PR.csv'), 'wt') as csvfile:

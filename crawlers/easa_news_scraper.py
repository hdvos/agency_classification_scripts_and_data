...
def make_url(i):
    return f'https://www.easa.europa.eu/newsroom-and-events/news?page={i}'
...
def make_newspage_url(ending):
    return parse.urljoin('https://www.easa.europa.eu/newsroom-and-events', ending)
...
with open(os.path.join(output_folder, 'EASA_NEWS.json'), 'wt') as f:
    json.dump(full_json, f)

# write to csv
with open(os.path.join(output_folder,'EASA_NEWS.csv'), 'wt') as csvfile:
